...
</xsl:import><xsl:param name="layout" select="'salzburg'">
...
<div id="im_fbbsc2">
<img height="100%" width="100%" src="../images/fbbsc2.jpg">
</img></div></div></div><div id="header_col2">
<div id="hcol2_content">
<div id="im_stones3">
<img height="100%" width="100%" src="../images/stones3.jpg">
</img></div></div></div><div id="header_col3">
<div id="hcol3_content" class="clearfix">
<div id="im_stones3_1">
<img height="100%" width="100%" src="../images/stones3.jpg">
</img></div></div></div></div><div id="nav">
<div id="nav_main" class="nav">
<xsl:call-template name="elml:navigation">
</xsl:call-template></div></div><div id="main">
<div id="col3">
<div id="col3_content">
