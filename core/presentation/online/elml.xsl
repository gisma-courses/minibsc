...
<xsl:stylesheet xmlns:elml="http://www.elml.ch" xmlns="http://www.w3.org/1999/xhtml" xmlns:xhtml="http://www.w3.org/1999/xhtml" version="2.0" xmlns:functx="http://www.functx.com" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="#all">
    ...
    <xsl:output method="xml" version="1.0" indent="yes" encoding="UTF-8" omit-xml-declaration="no" media-type="application/xhtml+xml" use-character-maps="comment" name="html5"/>
    <xsl:output method="xhtml" version="1.0" encoding="UTF-8" indent="yes" omit-xml-declaration="no" doctype-public="-//W3C//DTD XHTML 1.1//EN" doctype-system="http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd" media-type="text/html" use-character-maps="comment" name="xhtml11"/>
    ...
    <xsl:variable name="filename_suffix">
        <xsl:choose>
            <xsl:when test="//elml:multimedia/@type='mathml' or //elml:multimedia/@type='svg'">
        ...
        <head>
            ...
            <xsl:choose>
                <xsl:when test="not($layout='none')">
                    <link rel="stylesheet" href="../../../_templates/{$layout}/elml.css" type="text/css" media="screen"/>
                    <link rel="stylesheet" href="../../../_templates/{$layout}/elml_print.css" type="text/css" media="print,handheld"/>
                    <script src="../../../_templates/{$layout}/elml.js" type="text/javascript"><xsl:comment> </xsl:comment></script>
                </xsl:when>
                <xsl:when test="$css_framework='yaml'">
                    <link rel="stylesheet" href="http://www.yaml.de/fileadmin/css/layout_2col_left.css" type="text/css" media="screen"/>
            ...
            <xsl:if test="$html_version='5'">
                <xsl:call-template name="keypress"/>
            ...
            <xsl:if test="$lightwindow='yes' and not($layout='none')">
                <script type="text/javascript" src="../../../_templates/{$layout}/lightwindow/javascript/prototype.js" id="lwloader_prototype_js"><xsl:comment> </xsl:comment></script>
                <script type="text/javascript" src="../../../_templates/{$layout}/lightwindow/javascript/effects.js" id="lwloader_effects_js"><xsl:comment> </xsl:comment></script>
                <script type="text/javascript" src="../../../_templates/{$layout}/lightwindow/javascript/lightwindow_loader.js" id="lwloader"><xsl:comment> </xsl:comment></script>
            </xsl:if>
            <xsl:if test="$manifest_type='scorm'">
                <script type="text/javascript" language="JavaScript1.2" src="scorm_generic.js"><xsl:comment> </xsl:comment></script>
            </xsl:if>
        </head>
    </xsl:template>
    <xsl:template name="keypress">
        <xsl:param name="prev">
        ...
        <script type="text/javascript" language="JavaScript"><![CDATA[ document.onkeyup = KeyCheck;    
	function KeyCheck(e)
		{var KeyID = (window.event) ? event.keyCode : e.keyCode;
		if (KeyID.ctrlKey) {alert("control")};
		   switch(KeyID)
		   { 
]]>  
            <xsl:if test="not($prev='none.html')">  
                <xsl:text>case 37: if(e.ctrlKey) { window.location = "index.html" } else {window.location = "</xsl:text>
                <xsl:value-of select="$prev"/>
                <xsl:text>"}; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="not($next='none.html')">  
                <xsl:text>case 39: window.location = "</xsl:text>
                <xsl:value-of select="$next"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[1]">  
                <xsl:text>case 49: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[1]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[2]">  
                <xsl:text>case 50: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[2]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[3]">  
                <xsl:text>case 51: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[3]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[4]">  
                <xsl:text>case 52: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[4]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[5]">  
                <xsl:text>case 53: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[5]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[6]">  
                <xsl:text>case 54: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[6]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[7]">  
                <xsl:text>case 55: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[7]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[8]">  
                <xsl:text>case 56: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[8]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:unit[9]">  
                <xsl:text>case 57: window.location = "</xsl:text>
                <xsl:text>unit_</xsl:text>
                <xsl:value-of select="/elml:lesson/elml:unit[9]/@label"/>
                <xsl:value-of select="$filename_suffix"/>
                <xsl:text>"; break;
                </xsl:text> 
            </xsl:if>
            <xsl:if test="not($contact='') ">                    
                <xsl:text>case 67: if(e.ctrlKey) {window.location = "</xsl:text>
            ...
            <xsl:if test="/elml:lesson/elml:glossary">  
                <xsl:text>case 71: if(e.ctrlKey) {window.location = "</xsl:text>
                <xsl:value-of select="/elml:lesson/@label"/>
            ...
            <xsl:if test="/elml:lesson/elml:index">  
                <xsl:text>case 73: if(e.ctrlKey) {window.location = "</xsl:text>
                <xsl:value-of select="/elml:lesson/@label"/>
            ...
            <xsl:if test="/elml:lesson/elml:bibliography">  
                <xsl:text>case 66: if(e.ctrlKey) {window.location = "</xsl:text>
                <xsl:value-of select="/elml:lesson/@label"/>
            ...
            <xsl:if test="/elml:lesson/elml:bibliography">  
                <xsl:text>case 80: if(e.ctrlKey) {window.location = "../text/</xsl:text>
                <xsl:value-of select="/elml:lesson/@label"/>
                    ...
                    <div class="page_margins">
                        <div class="page">
                            ...
                            <div id="main" class="hidecol2">
                                ...
                                <!-- #col1: - End -->
                                <!-- #col2: Second column not used in eLML (could contain e.g. context information from annotation tag) -->
                                <div id="col2">
    ...
    <xsl:template name="elml:LayoutBodySkiplinks">
        <xsl:if test="$use_navigation='yes'">
            ...
            <a class="skip" style="position: absolute; left: -1000em; width: 20em;">
    ...
    <xsl:template name="elml:LayoutBodyContent">
        ...
        <xsl:choose>
            ...
            <xsl:when test="name(.)='listOfTables'">
                <xsl:call-template name="elml:Legend_listof_tables"/>
            </xsl:when>
            ...
            <xsl:when test="name(.)='listOfFigures'">
                <xsl:call-template name="elml:Legend_listof_figures"/>
            </xsl:when>
                    ...
                    <xsl:for-each-group select="//elml:indexItem" group-by="(if (@affiliatedTo) then  @affiliatedTo else .)">
                        ...
                        <li>
                            ...
                            <xsl:for-each select="current-group()">
                                ...
                                <a>
                                    <xsl:attribute name="href">
                                        <xsl:for-each select="ancestor::node()[name()='learningObject' or name()='selfAssessment' or name()='furtherReading' or name()='unit' or name()='lesson' or name()='glossary'][1]">
                    ...
                    <xsl:when test="@sorting='byYear'">
                        <ul class="furtherReading">
                            <xsl:for-each select="elml:resItem">
                                ...
                                <xsl:sort select="/elml:lesson/elml:bibliography/*[@bibID=current()/@bibIDRef]/@accessedDate" order="descending" lang="{$lang}"/>
                                <xsl:apply-templates select="/elml:lesson/elml:bibliography/*[@bibID=current()/@bibIDRef]">
                                    <xsl:with-param name="comment" select="text()"/>
                                    <xsl:with-param name="furtherReading" select="@bibIDRef"/>
                                    <xsl:with-param name="pageNr" select="@pageNr"/>
                    ...
                    <xsl:when test="@sorting='byYear'">
                        <ul class="bibliography">
                            <xsl:apply-templates>
                                ...
                                <xsl:sort select="@accessedDate" order="descending" lang="{$lang}"/>
                            </xsl:apply-templates>
                        </ul>
                    </xsl:when>
                    <xsl:when test="@sorting='groupByType'">
        ...
        <xsl:if test="$glossaryMousoverWithHTML='yes'">
            <xsl:if test="not((name(.)='clarify') or (name(.)='look') or (name(.)='act'))">
                <xsl:for-each-group select=" descendant::node()/elml:term" group-by="@glossRef">
                    <xsl:sort select="@glossRef"/>
                    <xsl:variable name="termid" select="@glossRef"/>
                    <div style="display:none;">
                        <xsl:attribute name="id">
                            <xsl:text>term</xsl:text>
                            <xsl:value-of select="generate-id(/elml:lesson/elml:glossary/elml:definition[@term=$termid])"/>
                        </xsl:attribute>
                        <xsl:value-of select="/elml:lesson/elml:glossary/elml:definition[@term=$termid]/text()"></xsl:value-of>
    ...
    <xsl:template name="elml:Legend_listof_tables">
        <ul>
            <xsl:call-template name="elml:CSS_Class"/>
    ...
    <xsl:template name="elml:Legend_listof_figures">
        <ul>
            <xsl:call-template name="elml:CSS_Class"/>
    ...
    <xsl:template match="elml:lesson">
        ...
        <xsl:if test="($pagebreak_level='lesson') or ($pagebreak_level='unit') or ($pagebreak_level='lo')">
            <xsl:choose>
    ...
    <xsl:template match="elml:unit">
        ...
        <xsl:choose>
            <xsl:when test="$html_version='5' and (($pagebreak_level='unit') or ($pagebreak_level='lo'))">
                <xsl:result-document href="{elml:get_pathHTML(base-uri(),/elml:lesson/@label)}{$filename}" format="html5">
                    <html lang="{$lang}" xml:lang="{$lang}">
                        <xsl:call-template name="elml:LayoutHead"/>
                        <xsl:call-template name="elml:LayoutBody"/>
            ...
            <xsl:when test="$html_version='1.1' and (($pagebreak_level='unit') or ($pagebreak_level='lo'))">
                <xsl:result-document href="{elml:get_pathHTML(base-uri(),/elml:lesson/@label)}{$filename}" format="xhtml11">
                    <html xml:lang="{$lang}">
                        <xsl:call-template name="elml:LayoutHead"/>
                        <xsl:call-template name="elml:LayoutBody"/>
    ...
    <xsl:template match="elml:learningObject">
        ...
        <xsl:choose>
            <xsl:when test="$html_version='5' and ($pagebreak_level='lo')">
                <xsl:result-document href="{elml:get_pathHTML(base-uri(),/elml:lesson/@label)}{$filename}" format="html5">
                    <html lang="{$lang}" xml:lang="{$lang}">
                        <xsl:call-template name="elml:LayoutHead"/>
                        <xsl:call-template name="elml:LayoutBody"/>
            ...
            <xsl:when test="$html_version='1.1' and ($pagebreak_level='lo')">
                <xsl:result-document href="{elml:get_pathHTML(base-uri(),/elml:lesson/@label)}{$filename}" format="xhtml11">
                    <html xml:lang="{$lang}">
                        <xsl:call-template name="elml:LayoutHead"/>
                        <xsl:call-template name="elml:LayoutBody"/>
    ...
    <xsl:template match="elml:selfAssessment">
        ...
        <xsl:choose>
            <xsl:when test="$html_version='5' and ((($pagebreak_level='unit') and (name(parent::*)='lesson')) or ($pagebreak_level='lo'))">
                <xsl:result-document href="{elml:get_pathHTML(base-uri(),/elml:lesson/@label)}{$filename}" format="html5">
                    <html lang="{$lang}" xml:lang="{$lang}">
                        <xsl:call-template name="elml:LayoutHead"/>
                        <xsl:call-template name="elml:LayoutBody"/>
            ...
            <xsl:when test="$html_version='1.1' and ((($pagebreak_level='unit') and (name(parent::*)='lesson')) or ($pagebreak_level='lo'))">
                <xsl:result-document href="{elml:get_pathHTML(base-uri(),/elml:lesson/@label)}{$filename}" format="xhtml11">
                    <html xml:lang="{$lang}">
                        <xsl:call-template name="elml:LayoutHead"/>
                        <xsl:call-template name="elml:LayoutBody"/>
    ...
    <xsl:template name="elml:BibliographyRef">
        ...
        <xsl:if test="@bibIDRef">
            ...
            <xsl:text> (</xsl:text>
            <xsl:choose>
                <xsl:when test="@yearOnly='yes' and /elml:lesson/elml:bibliography/*[@bibID=$id]/@publicationYear">
                    <a class="bibLink" href="{$bibLink}">
            ...
            <table>
                ...
                <xsl:choose>
                    <xsl:when test="elml:tablerow[1]/elml:tableheading">
                        ...
                        <tbody>
                            <xsl:for-each select="elml:tablerow[position()&gt;1]">
                                <tr>
                                    <xsl:call-template name="elml:CSS_Class"/>
                                    <xsl:apply-templates/>
                                </tr>
    ...
    <xsl:template match="elml:term">
        ...
        <xsl:choose>
            ...
            <xsl:when test="ancestor::node()[name()='definition']">
                <xsl:choose>
                    <xsl:when test="$html_version='1.1' or $html_version='5'">
                        <dfn>
                            <xsl:value-of select="$term"/>
                        </dfn>
                    </xsl:when>
    ...
    <xsl:template match="elml:link">
        ...
        <xsl:param name="TempURL">
            <xsl:choose>
                ...
                <!-- This is a weired test to see if its an ePub format and if it is then absolute links are used (no links to local documents allowed in ePub) -->
                <xsl:when test="@uri and starts-with(@uri, '..') and ($html_version='1.1' or $html_version='5') and $multiple='off' and $css_framework='none' and $use_embed='no' and $lightwindow='no' and $manifest_type='ims' and $use_navigation='no'">
                    <xsl:value-of select="$server"/>
                    <xsl:text>/</xsl:text>
                    <xsl:value-of select="/elml:lesson/@label"/>
                    <xsl:text>/</xsl:text>
                ...
                <xsl:otherwise>
                    <xsl:choose>
                        <xsl:when test="not($target_lesson_file='none')">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="@targetLabel and doc-available($target_lesson_file)">
                                    <xsl:value-of select="$target_lesson_html"/>
                                    <xsl:choose>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="not($target_lesson_file='none') and $pagebreak_level='unit' and document($target_lesson_file)//*[@label=$label]/ancestor::node()[name()='unit'][1]/@label">
                            <xsl:text>#</xsl:text>
                            <xsl:value-of select="document($target_lesson_file)//*[@label=$label]/../@label"/>
                            <xsl:text>_</xsl:text>
                            <xsl:value-of select="@targetLabel"/>
            ...
            <xsl:when test="($inline='no') and not(name(preceding-sibling::*[1])='link') and not(name(following-sibling::*[1])='link')">
                <p>
                    ...
                    <xsl:element name="a">
                        ...
                        <xsl:if test="not($html_version='1.1') and (starts-with($TempURL, 'http') or ends-with($TempURL, '.pdf') or @target)">
    ...
    <xsl:template name="elml:selfCheckButtons">
        ...
        <div class="itemCheck">
            ...
            <button type="submit" class="buttonSolution_disabled" id="{$selfCheckLabel}_solution" onclick="solution{$selfCheckFunction}('{$selfCheckLabel}');" onmouseover="this.className='buttonSolution_hover';" onmouseout="this.className='buttonSolution';" disabled="disabled">
    ...
    <xsl:template match="elml:citation">
        ...
        <xsl:param name="id" select="@bibIDRef"/>
        <xsl:param name="citation_uri">
            <xsl:if test="($pagebreak_level='unit') or ($pagebreak_level='lo')">
                <xsl:value-of select="/elml:lesson/@label"/>
                <xsl:text>_bibliography</xsl:text>
                <xsl:value-of select="$filename_suffix"/>
        ...
        <xsl:param name="citation_title">
            <xsl:if test="/elml:lesson/elml:bibliography/*[@bibID=$id]/@title">
                <xsl:value-of select="/elml:lesson/elml:bibliography/*[@bibID=$id]/@title"/>
                <xsl:text>; </xsl:text>
            </xsl:if>
            <xsl:if test="/elml:lesson/elml:bibliography/*[@bibID=$id]/@titleOfContribution">
                <xsl:value-of select="/elml:lesson/elml:bibliography/*[@bibID=$id]/@titleOfContribution"/>
                <xsl:text>; </xsl:text>
            </xsl:if>
            <xsl:choose>
                <xsl:when test="/elml:lesson/elml:bibliography/*[@bibID=$id]/@author">
            ...
            <xsl:if test="/elml:lesson/elml:bibliography/*[@bibID=$id]/@publicationYear">
                <xsl:text>; </xsl:text>
                <xsl:value-of select="/elml:lesson/elml:bibliography/*[@bibID=$id]/@publicationYear"/>
            </xsl:if>
        </xsl:param>
        <xsl:choose>
            <xsl:when test="($html_version='1.1' or $html_version='5') and not(node()) and $inline='no'"/>
            <xsl:when test="($html_version='1.1' or $html_version='5') and not(node())">
                <cite>
                    <xsl:call-template name="elml:CSS_Class"/>
                    <xsl:attribute name="title">
            ...
            <xsl:when test="($html_version='1.1' or $html_version='5') and $inline='no'">
                <blockquote>
                    ...
                    <xsl:attribute name="cite">
                        <xsl:value-of select="$citation_uri"/>
                    </xsl:attribute>
                    <xsl:attribute name="title">
                        <xsl:value-of select="$citation_title"/>
                    </xsl:attribute>
            ...
            <xsl:when test="($html_version='1.1' or $html_version='5') and $inline='yes'">
                <q>
                    <xsl:call-template name="elml:CSS_Class"/>
                    <xsl:attribute name="cite">
                        <xsl:value-of select="$citation_uri"/>
    ...
    <xsl:template match="elml:toc">
        <xsl:param name="toclessonlabel" select="/elml:lesson/@label"/>
        ...
        <ul class="toc">
            <xsl:choose>
                <xsl:when test="@scope='lessons' and $multiple='on'">
                    <xsl:for-each select="document($config_file)/elml:config/elml:modules/elml:course[child::node()=$transformlesson_label]/elml:labelname">
                        <xsl:apply-templates select="document(concat(substring-before($config_file,'_config'),text(),'/',$lang,'/text/',text(),'.xml'))/elml:lesson" mode="toc">
                            ...
                            <xsl:with-param name="toclessonlabel" select="$toclessonlabel"/>
                        </xsl:apply-templates>
                    </xsl:for-each>
                </xsl:when>
                ...
                <xsl:when test="@scope='learningObject'">
                    <xsl:text>ERROR! Use scope='learningObject' only witin a 'learningObject' element and only if you have clarify, look or act elements with a title-attribute!</xsl:text>
                </xsl:when>
                <xsl:otherwise>
    ...
    <xsl:template match="elml:lesson | elml:unit | elml:learningObject | elml:selfAssessment | elml:summary | elml:furtherReading | elml:glossary | elml:listOfFigures | elml:listOfTables | elml:index | elml:bibliography | elml:metadata | elml:clarify | elml:look | elml:act" mode="toc">
        ...
        <xsl:if test="$display='yes'">
            <li>
                <xsl:choose>
                    <xsl:when test="$toclessonlabel=@label">
                        <xsl:attribute name="class">
                            <xsl:text>active</xsl:text>
                        </xsl:attribute>
                        <xsl:call-template name="elml:nav_item_link">
                            <xsl:with-param name="isnavigation">toccurrent</xsl:with-param>
                        </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:attribute name="class">
                ...
                <xsl:if test="$toclessonlabel=@label or ($recurse='yes' and (name()='lesson' or name()='unit'))">
                    <ul class="toc">
                        <xsl:apply-templates select="elml:unit[(@role eq 'student') or (@role eq $role) or (not (@role))] | elml:selfAssessment | elml:summary | elml:furtherReading | elml:glossary[not(@visible eq 'print') and not(@visible eq 'none')] | elml:listOfFigures[not(@visible eq 'print') and not(@visible eq 'none')] | elml:listOfTables[not(@visible eq 'print') and not(@visible eq 'none')] | elml:index[not(@visible eq 'print') and not(@visible eq 'none')] | elml:bibliography[not(@visible eq 'print') and not(@visible eq 'none')] | elml:metadata[not(@visible eq 'print') and not(@visible eq 'none')] | elml:learningObject" mode="toc">
    ...
    <xsl:template name="elml:next_file">
        <xsl:param name="Label_param_temp">
            <xsl:choose>
                ...
                <xsl:when test="$pagebreak_level='unit' and name(following-sibling::*[1]) = 'metadata' and (following-sibling::*[1]/@visible='none' or following-sibling::*[1]/@visible='print' or (following-sibling::*[1]/@role and not(following-sibling::*[1]/@role=$role or following-sibling::*[1]/@role='student')))">
                    <xsl:text>none</xsl:text>
                </xsl:when>
                <xsl:when test="name(.)='listOfTables'">
                    <xsl:choose>
                ...
                <xsl:when test="name(.)='listOfFigures'">
                    <xsl:choose>
                        <xsl:when test="/elml:lesson/elml:listOfTables and not(/elml:lesson/elml:listOfTables/@visible='none') and not(/elml:lesson/elml:listOfTables/@visible='print')">
                            <xsl:value-of select="/elml:lesson/@label"/>
                            <xsl:text>_</xsl:text>
                ...
                <xsl:when test="name(.)='index'">
                    <xsl:choose>
                        <xsl:when test="/elml:lesson/elml:listOfFigures and not(/elml:lesson/elml:listOfFigures/@visible='none') and not(/elml:lesson/elml:listOfFigures/@visible='print')">
                            <xsl:value-of select="/elml:lesson/@label"/>
                            <xsl:text>_</xsl:text>
                ...
                <xsl:when test="$pagebreak_level='lo'">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="not(following-sibling::*[1])">
                            <xsl:choose>
                                <xsl:when test="(parent::*/following-sibling::*[1]/@role and not(parent::*/following-sibling::*[1]/@role=$role or parent::*/following-sibling::*[1]/@role='student')) or parent::*/following-sibling::*[1]/@visible='none' or parent::*/following-sibling::*[1]/@visible='print'">
            ...
            <xsl:choose>
                ...
                <xsl:when test="$pagebreak_level='lo'">
                    <xsl:choose>
                        ...
                        <xsl:when test="(preceding-sibling::*[1]/@role and not(preceding-sibling::*[1]/@role=$role or preceding-sibling::*[1]/@role='student')) or preceding-sibling::*[1]/@visible='none' or preceding-sibling::*[1]/@visible='print'">
                            <xsl:value-of select="preceding-sibling::*[2]/@label"/>
                        </xsl:when>
                        <xsl:when test="name(preceding-sibling::*[1]) = 'unit'">
                            <xsl:value-of select="preceding-sibling::*[1]/@label"/>
                    ...
                    <xsl:text>_</xsl:text>
                    <xsl:choose>
                        <xsl:when test="name(preceding-sibling::*[1])='unit' or (preceding-sibling::*[1]/@visible='none' and name(preceding-sibling::*[2])='unit') or (preceding-sibling::*[1]/@visible='print' and name(preceding-sibling::*[2])='unit')">
                            <xsl:choose>
                                <xsl:when test="(preceding-sibling::*[1]/@role and not(preceding-sibling::*[1]/@role=$role or preceding-sibling::*[1]/@role='student'))  or preceding-sibling::*[1]/@visible='none' or preceding-sibling::*[1]/@visible='print'">
                                    <xsl:choose>
    ...
    <xsl:template name="elml:MultimediaShowGalleryName">
        <xsl:choose>
        ...
        <xsl:choose>
                ...
                <a href="{$pathMultimediaSource}">
                    ...
                    <xsl:if test="$lightwindow='yes'">
                        ...
                        <xsl:attribute name="rel">
                            ...
                            <xsl:call-template name="elml:MultimediaShowGalleryName"/>
                            <xsl:text>]</xsl:text>
                        </xsl:attribute>
                    </xsl:if>
                    <xsl:if test="@legend">
                    ...
                    <xsl:choose>
                        <xsl:when test="$lightwindow='yes' and text()">
                            <xsl:attribute name="params">
                                <xsl:value-of select="text()"/>
                            </xsl:attribute>
                        </xsl:when>
                        <xsl:when test="$lightwindow='yes' and (@type='flash' or @type='mpeg')">
                            <xsl:attribute name="params">
                                <xsl:text>lightwindow_width=800,lightwindow_height=600</xsl:text>
                            </xsl:attribute>
                        </xsl:when>
                    </xsl:choose>
            ...
            <xsl:when test="@type">
                <xsl:choose>
                    ...
                    <xsl:when test="$html_version='5' and (@type='quicktime' or @type='mpeg')">
                        <video>
                            <xsl:call-template name="elml:Label"/>
                            ...
                            <xsl:choose>
                                <xsl:when test="ancestor::node()/name()='popup'">
                                    <xsl:attribute name="autoplay" select="'autoplay'"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:attribute name="controls" select="'controls'"/>
                                </xsl:otherwise>
                            </xsl:choose>
                            <xsl:value-of select="$name_html5support"/>
                            <a href="{$pathMultimedia}">
                                <xsl:value-of select="$name_download"/>
                                <xsl:text> Video</xsl:text>
                            </a>
                        </video>
                    </xsl:when>
                    <xsl:when test="$html_version='5' and (@type='mp3')">
                        <audio>
                            <xsl:call-template name="elml:Label"/>
                            <xsl:call-template name="elml:MultimediaAttributes"/>
                            <xsl:attribute name="src">
    ...
    <xsl:template name="elml:manifest_scorm">
        ...
        <manifest xmlns="http://www.imsproject.org/xsd/imscp_rootv1p1p2" xmlns:adlcp="http://www.adlnet.org/xsd/adlcp_rootv1p2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" identifier="MANIFEST-{/elml:lesson/@label}" version="ADL SCORM CP 1.2" xsi:schemaLocation="http://www.imsproject.org/xsd/imscp_rootv1p1p2 {$lessonlabel}{substring-after(elml:get_pathHTML(base-uri(),/elml:lesson/@label),/elml:lesson/attribute::label)}imscp_rootv1p1p2.xsd http://www.imsglobal.org/xsd/imsmd_rootv1p2p1  {$lessonlabel}{substring-after(elml:get_pathHTML(base-uri(),/elml:lesson/@label),/elml:lesson/attribute::label)}imsmd_rootv1p2p1.xsd http://www.adlnet.org/xsd/adlcp_rootv1p2 {$lessonlabel}{substring-after(elml:get_pathHTML(base-uri(),/elml:lesson/@label),/elml:lesson/attribute::label)}adlcp_rootv1p2.xsd">
            ...
            <organizations>
                <!-- the default attribute is mandatory-->
            ...
            <resources>
                ...
                <!-- the resource declaration of the assets used by all of the scos like the javascript files calling LMSinitialize() -->
                <!-- add more files here in the future if necessary... -->
                <resource identifier="ALLRESOURCES" adlcp:scormtype="asset" type="webcontent">
                    <xsl:attribute name="xml:base"><xsl:value-of select="/elml:lesson/@label"/>/<xsl:value-of select="$lang"/>/html/</xsl:attribute>
                    <file href="scorm_generic.js"/>
                </resource>
            </resources>
        </manifest>
    </xsl:template>
    ...
    <xsl:template name="elml:ims_metadata">
        <lom xmlns="http://www.imsglobal.org/xsd/imsmd_rootv1p2p1">
            ...
            <!-- the <relation> element (optional) is not included in the scorm 1.2 manifest file because this optional information is practically not evaluated by the LMS's and it has been causing an error within the blackboard LMS (version 8) -->
            <xsl:if test="/elml:lesson/elml:metadata/elml:organisation/elml:creationPosition/elml:previous and not($manifest_type='scorm')">
                <relation>
                    <kind>
                        <source>
                            <langstring xml:lang="x-none">LOMv1.0</langstring>
            ...
            <xsl:if test="/elml:lesson/elml:metadata/elml:organisation/elml:creationPosition/elml:following and not($manifest_type='scorm')">
                <relation>
                    <kind>
                        <source>
                            <langstring xml:lang="x-none">LOMv1.0</langstring>
    ...
    <xsl:template name="elml:nav_item_link">
        ...
        <xsl:choose>
            <xsl:when test="$isnavigation='toccurrent' or ($navact='_act' and (not($css_framework='yaml') or ($css_framework='yaml' and $isnavigation='yes')))">
                <strong>
                    <xsl:call-template name="elml:Kapitel">
    ...
    <xsl:template name="elml:page-of">
        <xsl:value-of select="$name_page"/>
        <xsl:text> </xsl:text>
        <xsl:number level="any" count="elml:lesson | elml:unit | elml:selfAssessment | elml:summary | elml:furtherReading | elml:glossary[not(@visible='online') and not(@visible='none')] | elml:listOfFigures[not(@visible='online') and not(@visible='none')] | elml:listOfTables[not(@visible='online') and not(@visible='none')] | elml:index[not(@visible='online') and not(@visible='none')] | elml:bibliography[not(@visible='online') and not(@visible='none')] | elml:metadata[not(@visible='online') and not(@visible='none')] | elml:learningObject"/>
        <xsl:text> </xsl:text>
        <xsl:value-of select="$name_page_of"/>
        <xsl:text> </xsl:text>
        <xsl:value-of select="1 + count(//elml:unit) + count(//elml:selfAssessment) + count(//elml:summary) + count(//elml:furtherReading) + count(//elml:glossary[not(@visible='online') and not(@visible='none')]) + count(//elml:listOfFigures[not(@visible='online') and not(@visible='none')]) + count(//elml:listOfTables[not(@visible='online') and not(@visible='none')]) + count(//elml:index[not(@visible='online') and not(@visible='none')]) + count(//elml:bibliography[not(@visible='online') and not(@visible='none')]) + count(//elml:metadata[not(@visible='online') and not(@visible='none')]) + count(//elml:learningObject)"/>
    </xsl:template>
    ...
    <xsl:template name="elml:footer">
        <xsl:choose>
            <xsl:when test="$html_version='5'">
                <footer class="footer">
                    <xsl:call-template name="elml:footerContent"/>
                </footer>
            </xsl:when>
            <xsl:otherwise>
                <p class="footer">
    ...
    <xsl:template name="elml:footerContent">
        ...
        <xsl:text> (</xsl:text>
        <a href="http://www.elml.org/">created with eLML</a>
        <xsl:text>) </xsl:text>
