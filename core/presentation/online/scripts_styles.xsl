...
<xsl:stylesheet xmlns:elml="http://www.elml.ch" xmlns="http://www.w3.org/1999/xhtml" xmlns:xhtml="http://www.w3.org/1999/xhtml" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="#all">
    <xsl:template name="elml:LayoutTooltip">
        <script src="wz_tooltip.js" type="text/javascript"><xsl:comment> </xsl:comment></script>
    </xsl:template>
    <xsl:template name="elml:LayoutSelfCheckScript">
        <xsl:text>
		</xsl:text>
        <script src="selfCheck.js" type="text/javascript"><xsl:comment> </xsl:comment></script>
    </xsl:template>
...
//=======  END OF TOOLTIP CONFIG, DO NOT CHANGE ANYTHING BELOW  ==============//
    ...
    <xsl:template name="elml:LayoutTooltipScript">
        <xsl:text disable-output-escaping="yes"> <![CDATA[
...
var config = new Object();
        ...
        <xsl:call-template name="elml:LayoutTooltipScriptConfig"/>
        <xsl:text disable-output-escaping="yes"> <![CDATA[
...
function trim(s) {
    ...
    <xsl:template name="elml:LayoutSelfCheckCSSCode">
        <xsl:text disable-output-escaping="yes"> <![CDATA[
/** ---------------- **/
/**  selfCheck       **/
/** ---------------- **/
...
span.itemFeedbackCorrect {
    ...
    <xsl:template name="elml:LayoutHeadDefaultCSS">
        <xsl:result-document href="{elml:get_pathHTML(base-uri(),/elml:lesson/@label)}stylesheet.css" format="script"><![CDATA[
		.multimedia  { border: 0; } 
		.popupTitle  { font-weight: bold; cursor: pointer; } 
		...
		.icon        { margin: 0.5em 1em 0.5em 0; float:left; padding-bottom: 3em; } 
		.footer      { font-size: 0.8em ; line-height: 1em; } 
		.term        { font-weight: bold; cursor: help } 
		.legend      { font-size: 0.8em; line-height: 1em; text-align: inherit; margin-top: 0.5em; margin-bottom: 1em; } 
		.indexItem   { font-style: italic } 
		...
		.multimedia_paragraph_left   { float: none; clear: right; padding: 1em 1em 1em 0; display: block; } 
		.multimedia_paragraph_center { text-align: center; width: 98%; float: none; padding: 1em; display: block; } 
		.multimedia_paragraph_right  { text-align: right; float: none; clear: left; padding: 1em 0 1em 1em; display: block; } 
		.multimedia_inline_left      { float: left; padding-right: 1em; padding-left: 0; display: inline; } 
		.multimedia_inline_center    { text-align: center; width: 98%; float: left; padding-right: 1em; padding-left: 1em; display: inline; } 
		.multimedia_inline_right     { text-align: right; float: right; padding-right: 0; padding-left: 1em; display: inline; }
		.multimedia_paragraph_center object, .multimedia_paragraph_center  embed {width: 98%}]]>
            <xsl:if test="$css_framework='yaml'"><![CDATA[
	    h1 {position:relative;height:auto;width:auto;margin-left:0;}
		]]>
            </xsl:if>
        </xsl:result-document>
    </xsl:template>
    <xsl:template name="elml:scorm_generic_js">
        <xsl:text disable-output-escaping="yes"> <![CDATA[
...
function timeSpend(StartTime) {
    ...
    <xsl:template name="elml:scorm_generic_imscp_xsd">
...
<xsd:schema xmlns="http://www.imsproject.org/xsd/imscp_rootv1p1p2" 
   ...
   <xsd:simpleType name="titleType">
    ...
    <xsl:template name="elml:scorm_generic_imsmd_xsd">
...
<xsd:schema targetNamespace="http://www.imsglobal.org/xsd/imsmd_rootv1p2p1" 
   ...
   <xsd:simpleType name="maximumversionType">
    ...
    <xsl:template name="elml:scorm_generic_adlcp_xsd">
        <xsl:text disable-output-escaping="yes"><![CDATA[<?xml version="1.0"?>
...
<xsd:schema xmlns="http://www.adlnet.org/xsd/adlcp_rootv1p2"
    ...
    <xsl:template name="elml:scorm_generic_xml_xsd">
        <xsl:text disable-output-escaping="yes"><![CDATA[<?xml version="1.0" encoding="UTF-8"?>
<!-- filename=ims_xml.xsd -->
<!-- xmlns="http://www.w3.org/XML/1998/namespace" removed from root element because of problems with Xerces 2.4.0 -->
<xsd:schema targetNamespace="http://www.w3.org/XML/1998/namespace" xmlns:xsd="http://www.w3.org/2001/XMLSchema"  elementFormDefault="unqualified" version="adapted for MSXML4">
