...
<xsl:stylesheet xmlns:elml="http://www.elml.ch" xmlns="http://www.w3.org/1999/xhtml" xmlns:xhtml="http://www.w3.org/1999/xhtml" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    <xsl:template name="elml:LayoutTooltip">
        <script src="wz_tooltip.js" type="text/javascript"><![CDATA[ ]]></script>
    </xsl:template>
    <xsl:template name="elml:LayoutSelfCheckScript">
        <xsl:text>
		</xsl:text>
        <script src="selfCheck.js" type="text/javascript"><![CDATA[ ]]></script>
    </xsl:template>
...
div.itemLabel { /* holds the text of the answers */
	float: left;
  width: 600px; /* must be 52px smaller than width of parent element */
	padding-top: 1px;
	padding-left: 2px;
	font-family: Arial;
	font-size: 12px;
