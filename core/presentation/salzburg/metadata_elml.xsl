...
<xsl:stylesheet xmlns:elml="http://www.elml.ch" xmlns="http://www.w3.org/1999/xhtml" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="elml:technical">
		<h3>
			<a name="Technical">Technical requirements</a>
		</h3>
	...
	<xsl:template match="elml:lessonInfo">
		<h3>
			<a name="Information">Lesson Information</a>
		</h3>
		<form action="">
			<table class="metadata_table">
				<tr>
	...
	<xsl:template match="elml:educational">
		...
		<tr>
			<td valign="top" nowrap="nowrap">Typical Learning Time: </td>
			<td>
