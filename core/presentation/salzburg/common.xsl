...
<xsl:stylesheet xmlns:elml="http://www.elml.ch" xmlns="http://www.w3.org/1999/xhtml" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="elml:WidthHeight">
        ...
        <xsl:if test="(@type='quicktime' or @type='mpeg' or @type='mp3' or @type='realone') and not(@width)">
            <xsl:attribute name="width">300</xsl:attribute>
        </xsl:if>
        <xsl:choose>
            <xsl:when test="@type='mp3' and not(@height)">
    ...
    <xsl:template name="elml:Quicktime">
        <xsl:param name="pathMultimedia"/>
        <object type="video/quicktime" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" coebase="http://www.apple.com/qtactivex/qtplugin.cab" pluginspage="http://www.apple.com/quicktime/download/" scale="aspect">
            <xsl:call-template name="elml:Label"/>
            <xsl:call-template name="elml:MultimediaAttributes"/>
            <xsl:attribute name="data">
                <xsl:value-of select="$pathMultimedia"/>
            ...
            <embed autoplay="false" controller="true" pluginspage="http://www.apple.com/quicktime/download/" type="video/quicktime" kioskmode="false" scale="aspect">
                <xsl:attribute name="src">
                    <xsl:value-of select="$pathMultimedia"/>
                </xsl:attribute>
                <xsl:call-template name="elml:MultimediaAttributes"/>
    ...
    <xsl:template name="elml:MPEG">
        <xsl:param name="pathMultimedia"/>
        <object type="video/mpeg" scale="aspect">
            <xsl:call-template name="elml:Label"/>
            <xsl:call-template name="elml:MultimediaAttributes"/>
            <xsl:attribute name="data">
                <xsl:value-of select="$pathMultimedia"/>
            ...
            <param name="autoplay" value="false"/>
            <param name="controller" value="true"/>
            <embed autoplay="false" controller="true" pluginspage="http://www.apple.com/quicktime/download/" type="video/mpeg" autostart="false" scale="aspect">
                <xsl:attribute name="src">
                    <xsl:value-of select="$pathMultimedia"/>
                </xsl:attribute>
                <xsl:call-template name="elml:MultimediaAttributes"/>
    ...
    <xsl:template name="elml:MP3">
        ...
        <object type="audio/mpeg">
            ...
            <param name="autoplay" value="false"/>
            <param name="controller" value="true"/>
            <embed autoplay="false" controller="true" pluginspage="http://www.apple.com/quicktime/download/" type="audio/mpeg" autostart="false">
                <xsl:attribute name="src">
                    <xsl:value-of select="$pathMultimedia"/>
                </xsl:attribute>
                <xsl:call-template name="elml:MultimediaAttributes"/>
    ...
    <xsl:template name="elml:RealOne">
        ...
        <object type="audio/x-pn-realaudio-plugin">
            ...
            <embed pluginspage="http://www.real.com/" type="audio/x-pn-realaudio-plugin" controls="ImageWindow" autostart="false">
                <xsl:attribute name="src">
                    <xsl:value-of select="$pathMultimedia"/>
                </xsl:attribute>
                <xsl:call-template name="elml:MultimediaAttributes"/>
