...
public class ElmlLook extends Elements {
	...
	public void addContent(String label, String title, String navTitle) {
		try {
			...
			xCursorProps.setPropertyValue("ParaStyleName", "ElmlLook");
	...
	public void createDialog(String elementTitle, String elementLabel,
		...
		xDialogController.setWindowProperties("Look", 100, 100, 170, 140);
