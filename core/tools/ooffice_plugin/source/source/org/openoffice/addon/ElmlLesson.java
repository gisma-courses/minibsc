...
public class ElmlLesson extends Elements {
	...
	public void addContent(String label, String title, String navTitle) {
		try {
			...
			xText.insertTextContent(xModelCursor, xSection, false);
			...
			xCursorProps.setPropertyValue("ParaStyleName", "ElmlLesson");
	...
	public void getDepending() {
		if (ModeSet != MODE_CANCEL) {
			...
			ElementController.createElement("ElmlGlossary");
			ElementController.createElement("ElmlBibliography");
		}
	}
	...
	public void createDialog(String elementTitle, String elementLabel,
		...
		xDialogController.setWindowProperties("Lesson", 100, 100, 170, 140);
