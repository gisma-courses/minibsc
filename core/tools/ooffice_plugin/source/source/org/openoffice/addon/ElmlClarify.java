...
public class ElmlClarify extends Elements {
	...
	public void addContent(String label, String title, String navTitle) {
		try {
			...
			xCursorProps.setPropertyValue("ParaStyleName", "ElmlClarify");
	...
	public void createDialog(String elementTitle, String elementLabel,
		...
		xDialogController.setWindowProperties("Clarify", 100, 100, 170, 140);
